...
// load_ggml_backends loads CPU/Metal/BLAS backend plugins before whisper init.
// Required when using dynamic backend plugins (homebrew ggml 0.9.8+).
static void load_ggml_backends(void) {
